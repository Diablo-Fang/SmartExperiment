    ...
    Rectangle{
        ...
        ListModel{
            ...
            ListElement{
                ...
                cimage:"qrc:/images/home/exp.png"
                cname: qsTr("开始实验")
                subNode: [
                    ListElement {
                        aimage: "qrc:/images/home/sbq.png"
                        application: qsTr("实验1")
                        aqml: "workpage.qml"
                        acolor: "#02b9db"
                    }
                ]
            ...
            ListElement{
                catalogue:"testtool"
                cimage:"qrc:/images/home/tool.png"
                cname: qsTr("调试工具")
                subNode: [
                    ListElement {
                        aimage: "qrc:/images/home/internet.png"
                        application: qsTr("SPCI调试")
                        aqml: "ScpiTestWindow.qml"
                        acolor: "#02b9db"
                    }
                ]
            }
            ListElement{
                catalogue:"system"
                cimage:"qrc:/images/home/sys.png"
                cname: qsTr("系统")
                subNode: [
                    ListElement {
            ...
            RowLayout{
                ...
                Repeater{
                    ...
                    model:{
                        ...
                        console.log("当前选中索引 index="+index)
                        console.log("currentIndex="+pathView.currentIndex)
                        viewModel.get(index).subNode
                    }
                    Rectangle{
                        id:rootrect
                            ...
                            MouseArea{
                                ...
                                onClicked: {
                                    ...
                                    if(model.aqml === "InfoWindow.qml"){
                                        ...
                                        mainloader.item.show()
                                        mainloader.item.requestActivate()
                                    }else if(model.aqml === "ScpiTestWindow.qml"){
                                        mainloader.source = "ScpiTestWindow.qml"
                                        mainloader.item.show();
                                        mainloader.item.requestActivate();
                                    }else if(model.aqml === "workpage.qml"){
